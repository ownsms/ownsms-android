...
@Composable
fun SettingsScreen(vm: MainViewModel, onRequestPermissions: () -> Unit, onIgnoreBattery: () -> Unit) {
    ...
    Column(
        ...
        SettingsCard(stringResource(R.string.settings_readiness_title)) {
        ...
        SettingsCard(stringResource(R.string.settings_server_title)) {
            OutlinedTextField(
                value = url,
        ...
        if (savedToken.isNotBlank()) {
            SettingsCard(stringResource(R.string.settings_account_title)) {
                CopyableField(
            ...
            SettingsCard(stringResource(R.string.settings_test_sms_title)) {
                Text(
