...
android {
    ...
    buildTypes {
        release {
            ...
            // Debug-signed so `assembleRelease` runs locally without a keystore. Replace with a
            // real release keystore/signingConfig before publishing to Play.
